...
<div id="main_container">
        ...
        <div class="right_content">
            <div class="shopping_cart">
                ...
                <div class="cart_details"> تعداد محصول : {{count(collect($cart)->pluck('items')->toArray()[0])}} <br/>
                    <span class="border_cart"></span> مبلغ : <span class="price">{{number_format($price)}}تومان</span>
                </div>
                <div class="cart_icon"><a href="/cart" title="header=[Checkout] body=[&nbsp;] fade=[on]"><img
                            src="image/shoppingcart.png" alt="" width="48" height="48" border="0"/></a></div>
            </div>
    ...
    <div class="footer">
        ...
        <div class="right_footer"><a href="/home">home</a> <a href="/about">about</a> <a href="/sitemap">sitemap</a> <a
                href="#">rss</a> <a href="/contact">contact us</a></div>
    </div>
</div>
